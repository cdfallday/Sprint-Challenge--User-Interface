...
semantic html provides meaning to html giving structure

2. Name two big differences between ```display: block;``` and ```display: inline;```.

A block element always starts on a new line and fills up the horizontal margins.Inline doesn't start on a new line and appear on the same line as the content tags beside theml
...
The are aligned at the center of the cross axis.

5. Explain why git is valuable to a team of developers.

Git is valuable for version control
